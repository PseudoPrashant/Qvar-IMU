...
{
  ism330bx_func_cfg_access_t func_cfg_access = {0};
  ism330bx_ctrl3_t ctrl3 = {0};
  int32_t ret = 0;
  ...
  ctrl3.boot = (val == ISM330BX_RESTORE_CAL_PARAM) ? 1u : 0u;
  ctrl3.sw_reset = (val == ISM330BX_RESTORE_CTRL_REGS) ? 1u : 0u;
  func_cfg_access.sw_por = (val == ISM330BX_GLOBAL_RST) ? 1u : 0u;
...
{
  ism330bx_who_am_i_t who_am_i = {0};
  int32_t ret = 0;
                                  ...
                                  ism330bx_xl_self_test_t *val)
{
  ...
  switch (ctrl10.st_xl)
  {
    ...
    case 0x01:
      *val = ctrl10.xl_st_offset == 0u ? ISM330BX_XL_ST_POSITIVE : ISM330BX_XL_ST_OFFSET_POS;
      break;

    case 0x02:
      *val = ctrl10.xl_st_offset == 0u ? ISM330BX_XL_ST_NEGATIVE : ISM330BX_XL_ST_OFFSET_NEG;
      break;
...
{
  ism330bx_emb_func_status_mainpage_t emb_func_status_mainpage = {0};
  ism330bx_emb_func_exec_status_t emb_func_exec_status = {0};
  ism330bx_fsm_status_mainpage_t fsm_status_mainpage = {0};
  ism330bx_mlc_status_mainpage_t mlc_status_mainpage = {0};
  ism330bx_functions_enable_t functions_enable = {0};
  ism330bx_emb_func_src_t emb_func_src = {0};
  ism330bx_fifo_status2_t fifo_status2 = {0};
  ism330bx_all_int_src_t all_int_src = {0};
  ism330bx_wake_up_src_t wake_up_src = {0};
  ism330bx_status_reg_t status_reg = {0};
  ism330bx_d6d_src_t d6d_src = {0};
  ism330bx_tap_src_t tap_src = {0};
  uint8_t buff[7] = {0};
  int32_t ret = 0;
...
{
  ism330bx_status_reg_t status = {0};
  int32_t ret = {0};
...
{
  ism330bx_internal_freq_t internal_freq = {0};
  int32_t ret = {0};
...
{
  ism330bx_tdm_cfg1_t tdm_cfg1 = {0};
  int32_t ret = {0};
...
{
  ism330bx_page_address_t  page_address = {0};
  ism330bx_page_sel_t page_sel = {0};
  ism330bx_page_rw_t page_rw = {0};
  uint8_t msb = {0};
  uint8_t lsb = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  ism330bx_emb_func_cfg_t emb_func_cfg = {0};
  ism330bx_tdm_cfg2_t tdm_cfg2 = {0};
  ism330bx_ctrl4_t ctrl4 = {0};
  int32_t ret = {0};
...
{
  ism330bx_wake_up_ths_t wake_up_ths = {0};
  ism330bx_tap_cfg0_t tap_cfg0 = {0};
  int32_t ret = {0};
...
{
  ism330bx_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};
...
{
  ism330bx_functions_enable_t functions_enable = {0};
  ism330bx_pin_int_route_t  pin_int2_route = {0};
  ism330bx_inactivity_dur_t inactivity_dur = {0};
  ism330bx_emb_func_int1_t emb_func_int1 = {0};
  ism330bx_pedo_cmd_reg_t pedo_cmd_reg = {0};
  ism330bx_int2_ctrl_t int2_ctrl = {0};
  ism330bx_int1_ctrl_t int1_ctrl = {0};
  ism330bx_fsm_int1_t fsm_int1 = {0};
  ism330bx_mlc_int1_t mlc_int1 = {0};
  ism330bx_md1_cfg_t md1_cfg = {0};
  ism330bx_md2_cfg_t md2_cfg = {0};
  ism330bx_ctrl4_t ctrl4 = {0};
  int32_t ret = {0};
...
{
  ism330bx_functions_enable_t functions_enable = {0};
  ism330bx_pin_int_route_t  pin_int1_route = {0};
  ism330bx_inactivity_dur_t inactivity_dur = {0};
  ism330bx_emb_func_int2_t emb_func_int2 = {0};
  ism330bx_pedo_cmd_reg_t pedo_cmd_reg = {0};
  ism330bx_int2_ctrl_t int2_ctrl = {0};
  ism330bx_fsm_int2_t fsm_int2 = {0};
  ism330bx_mlc_int2_t mlc_int2 = {0};
  ism330bx_ctrl7_t ctrl7 = {0};
  ism330bx_md2_cfg_t md2_cfg = {0};
  ism330bx_ctrl4_t ctrl4 = {0};
  int32_t ret = {0};
...
{
  ism330bx_inactivity_ths_t inactivity_ths = {0};
  ism330bx_inactivity_dur_t inactivity_dur = {0};
  ism330bx_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
  float_t tmp = 0.0f;
...
{
  ism330bx_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  ism330bx_tap_ths_6d_t tap_ths_6d = {0};
  ism330bx_tap_cfg2_t tap_cfg2 = {0};
  ism330bx_tap_cfg1_t tap_cfg1 = {0};
  int32_t ret = {0};
...
{
  ism330bx_wake_up_dur_t wake_up_dur = {0};
  ism330bx_free_fall_t free_fall = {0};
  int32_t ret = {0};
...
{
  ism330bx_fifo_ctrl1_t fifo_ctrl1 = {0};
  int32_t ret = {0};
...
{
  ism330bx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
int32_t ism330bx_fifo_compress_algo_real_time_set(const stmdev_ctx_t *ctx,
                                                  uint8_t val)
{
  ism330bx_emb_func_en_b_t emb_func_en_b = {0};
  ism330bx_fifo_ctrl2_t fifo_ctrl2 = {0};
...
{
  ism330bx_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  ism330bx_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
...
int32_t ism330bx_fifo_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                                  uint16_t val)
{
  ism330bx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  ism330bx_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
...
{
  ism330bx_emb_func_fifo_en_a_t emb_func_fifo_en_a = {0};
  int32_t ret = {0};
...
{
  uint8_t buff[2] = {0};
  ism330bx_fifo_status2_t status = {0};
  int32_t ret = {0};
...
{
  ism330bx_fifo_data_out_tag_t fifo_data_out_tag = {0};
  uint8_t buff[7] = {0};
  int32_t ret = {0};
...
{
  ism330bx_emb_func_fifo_en_b_t emb_func_fifo_en_b = {0};
  int32_t ret = {0};
...
{
  ism330bx_emb_func_en_a_t emb_func_en_a = {0};
  ism330bx_emb_func_en_b_t emb_func_en_b = {0};
  ism330bx_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = {0};
...
{
  ism330bx_pedo_deb_steps_conf_t pedo_deb_steps_conf = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t ism330bx_sflp_game_rotation_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ism330bx_emb_func_en_a_t emb_func_en_a = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t ism330bx_sflp_game_rotation_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ism330bx_emb_func_en_a_t emb_func_en_a = {0};
  int32_t ret = {0};
...
{
  ism330bx_sflp_odr_t sflp_odr = {0};
  int32_t ret = {0};
...
int32_t ism330bx_sflp_game_gbias_set(const stmdev_ctx_t *ctx,
                                     const ism330bx_sflp_gbias_t *val)
{
  ism330bx_sflp_data_rate_t sflp_odr = ISM330BX_SFLP_15Hz;
  ism330bx_emb_func_exec_status_t emb_func_sts = {0};
  ism330bx_data_ready_t drdy = {0};
  ...
  if ((conf_saved[0] & 0x0FU) == (uint8_t)ISM330BX_XL_ODR_OFF)
  {
  ...
  for (i = 0; i < 3; i++)
  {
    ...
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x02 + 3 * i), &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x03 + 3 * i), &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x04 + 3 * i), &data_ptr[j], 1);
  }
  for (i = 0; i < 3; i++)
  {
    j = 0;
    data_tmp = 0;
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x0B + 3 * i), &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x0C + 3 * i), &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, (uint8_t)(0x0D + 3 * i), &data_ptr[j], 1);
  }
  master_config = 0x00;
  ret += ism330bx_write_reg(ctx, ISM330BX_FUNC_CFG_ACCESS, &master_config,
                            1);
...
{
  ism330bx_ctrl_status_t status = {0};
  int32_t ret = {0};
  ...
  *val = (status.fsm_wr_ctrl_status == 0u) ? ISM330BX_STD_IF_CONTROL : ISM330BX_FSM_CONTROL;
...
{
  ism330bx_emb_func_en_b_t emb_func_en_b = {0};
  ism330bx_fsm_enable_t fsm_enable = {0};
  int32_t ret = {0};
...
{
  ism330bx_fsm_programs_t fsm_programs = {0};
  int32_t ret = {0};
...
{
  ism330bx_emb_func_en_b_t emb_en_b = {0};
  ism330bx_emb_func_en_a_t emb_en_a = {0};
  int32_t ret = {0};
...
{
  ism330bx_z_ofs_usr_t z_ofs_usr = {0};
  ism330bx_y_ofs_usr_t y_ofs_usr = {0};
  ism330bx_x_ofs_usr_t x_ofs_usr = {0};
  ism330bx_ctrl9_t ctrl9 = {0};
  int32_t ret = {0};
  float_t tmp = 0.0f;
...
{
  ism330bx_tdm_cfg0_t tdm_cfg0 = {0};
  int32_t ret = {0};
